...
dependencies {
  ...
  jarJar(libs.adventureApi)
  implementation(libs.adventureKey)
  jarJar(libs.adventureKey)
  ...
  jarJar(libs.adventureTextSerializerGson)
  implementation(libs.adventureTextSerializerJson)
  jarJar(libs.adventureTextSerializerJson)
  implementation(libs.adventureTextSerializerPlain)
  jarJar(libs.adventureTextSerializerPlain)
  implementation(libs.minimessage)
  jarJar(libs.minimessage)
  implementation(libs.examinationApi)
  jarJar(libs.examinationApi)
  implementation(libs.examinationString)
  jarJar(libs.examinationString)
